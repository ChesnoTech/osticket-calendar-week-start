...
### Notes
- No code changes from v1.1.1 — version bump only.
- Test release used to exercise the auto-update flow end-to-end against a real
  GitHub release (not a forced-local downgrade).
